...
const (
	...
	EnvGeminiOAuthClientID     = "aigw-server_GEMINI_OAUTH_CLIENT_ID"
	EnvGeminiOAuthClientSecret = "aigw-server_GEMINI_OAUTH_CLIENT_SECRET"

	EnvAntigravityOAuthClientID     = "aigw-server_ANTIGRAVITY_OAUTH_CLIENT_ID"
	EnvAntigravityOAuthClientSecret = "aigw-server_ANTIGRAVITY_OAUTH_CLIENT_SECRET"
)
