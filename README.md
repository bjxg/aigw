...
> 🔗 The runtime panel source is configurable via `remote-management.panel-github-repository`. The default repository is [bjxg/aigw-panel](https://github.com/bjxg/aigw-panel).
...
- Make UI/interaction/copy changes in the panel source repository (default: `bjxg/aigw-panel`) and ship them via its release artifacts for the server to fetch.
